...
class Imagenet_matconvnet_vgg_verydeep_16_dag(nn.Module):

    def __init__(self):
        super().__init__()
        self.meta = {'mean': [122.74494171142578, 114.94409942626953, 101.64177703857422],
                     'std': [1, 1, 1],
                     'imageSize': [224, 224, 3]}
...
def Imagenet_vgg(weights_path=None, **kwargs):
    """
    ...
    """
    model = Imagenet_matconvnet_vgg_verydeep_16_dag()
    if weights_path:
